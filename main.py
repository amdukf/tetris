...
game_over_text = font.render('Game over , your score is :' , True , pygame.Color("black"))

record_text = font.render('High score:', True, pygame.Color('red'))
...
# Game over settings
    ...
    for i in range(HEIGHT):
        if field[i][0]:
            ...
            score = 0
            for i_rect in grid:
                sc.blit(game_over_text, (600, 120))
